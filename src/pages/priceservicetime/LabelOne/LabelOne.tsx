...
const LabelOne: React.FC<Props> = props => {
  ...
  useEffect(() => {
    props.fetchDataByLevelFromServer(1);
  }, []);
...
export default connect(mapToStateProps, mapDispatchToProps)(LabelOne);
